...
/**
 * <p>Java class for ConnectionABCD_Type complex type.
 * 
...
@XmlType(name = "ConnectionABCD_Type", propOrder = {
    "xOrYOrA"
})
public class ConnectionABCDType
    extends NamedIndexedRowType
{
    ...
    @XmlElements({
        ...
        @XmlElement(name = "A", type = AType.class),
        @XmlElement(name = "B", type = BType.class),
        @XmlElement(name = "C", type = CType.class),
        @XmlElement(name = "D", type = DType.class)
    })
     ...
     * This is why there is not a <CODE>set</CODE> method for the xOrYOrA property.
     * 
     * <p>
